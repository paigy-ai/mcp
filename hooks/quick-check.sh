...
PAIGY_TOOLS="mcp__paigy__contact,mcp__paigy__check_replies,mcp__paigy__get_thread,mcp__paigy__set_task_state,mcp__paigy__notify_user,mcp__paigy__schedule_callback"
